...
Through maven jacoco plugin configuration the CI pipeline fails when these limits are not reached. This leads to a high code quality through a significant test code coverage.
...
>
>This could be a good topic for another discussion. 
